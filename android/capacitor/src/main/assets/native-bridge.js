                ...
                if (doPatchHttp) {
                    ...
                    window.fetch = async (resource, options) => {
                        ...
                        try {
                            ...
                            let { data: requestData, type, headers } = await convertBody((options === null || options === void 0 ? void 0 : options.body) || undefined);
                            headers = Object.assign(Object.assign({}, ((options === null || options === void 0 ? void 0 : options.headers) ? options.headers : undefined)), headers);
                    ...
                    window.XMLHttpRequest.prototype.send = function (body) {
                        ...
                        try {
                            ...
                            convertBody(body)
                                ...
                                headers = Object.assign(Object.assign({}, this._headers), headers);
                                // intercept request & pass to the bridge
                                cap
